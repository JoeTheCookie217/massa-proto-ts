...
export enum BlockStatus {
  /** BLOCK_STATUS_UNSPECIFIED - Default enum value */
  BLOCK_STATUS_UNSPECIFIED = 0,
  /** BLOCK_STATUS_IN_BLOCKCLIQUE - The block is in the greatest clique (and not final) */
  BLOCK_STATUS_IN_BLOCKCLIQUE = 1,
  /** BLOCK_STATUS_FINAL - The block is final */
  BLOCK_STATUS_FINAL = 2,
  /** BLOCK_STATUS_CANDIDATE - The block is candidate (active any clique but not final) */
  BLOCK_STATUS_CANDIDATE = 3,
  /** BLOCK_STATUS_DISCARDED - The block is discarded */
...
export function blockStatusFromJSON(object: any): BlockStatus {
  switch (object) {
    ...
    case 1:
    case "BLOCK_STATUS_IN_BLOCKCLIQUE":
      return BlockStatus.BLOCK_STATUS_IN_BLOCKCLIQUE;
    case 2:
    case "BLOCK_STATUS_FINAL":
      return BlockStatus.BLOCK_STATUS_FINAL;
    case 3:
    case "BLOCK_STATUS_CANDIDATE":
      return BlockStatus.BLOCK_STATUS_CANDIDATE;
    case 4:
    case "BLOCK_STATUS_DISCARDED":
      return BlockStatus.BLOCK_STATUS_DISCARDED;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function blockStatusToJSON(object: BlockStatus): string {
  switch (object) {
    ...
    case BlockStatus.BLOCK_STATUS_IN_BLOCKCLIQUE:
      return "BLOCK_STATUS_IN_BLOCKCLIQUE";
    case BlockStatus.BLOCK_STATUS_FINAL:
      return "BLOCK_STATUS_FINAL";
    case BlockStatus.BLOCK_STATUS_CANDIDATE:
      return "BLOCK_STATUS_CANDIDATE";
    case BlockStatus.BLOCK_STATUS_DISCARDED:
      return "BLOCK_STATUS_DISCARDED";
...
function createBaseBlockWrapper(): BlockWrapper {
  return { id: "", block: undefined, status: [] };
}

export const BlockWrapper = {
  encode(message: BlockWrapper, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): BlockWrapper {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseBlockWrapper();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): BlockWrapper {
    return {
      id: isSet(object.id) ? String(object.id) : "",
      block: isSet(object.block) ? Block.fromJSON(object.block) : undefined,
      status: Array.isArray(object?.status) ? object.status.map((e: any) => blockStatusFromJSON(e)) : [],
    };
  },

  toJSON(message: BlockWrapper): unknown {
    const obj: any = {};
    message.id !== undefined && (obj.id = message.id);
    message.block !== undefined && (obj.block = message.block ? Block.toJSON(message.block) : undefined);
    if (message.status) {
      obj.status = message.status.map((e) => blockStatusToJSON(e));
    } else {
      obj.status = [];
    }
    return obj;
  ...
  create<I extends Exact<DeepPartial<BlockWrapper>, I>>(base?: I): BlockWrapper {
    return BlockWrapper.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<BlockWrapper>, I>>(object: I): BlockWrapper {
    const message = createBaseBlockWrapper();
    message.id = object.id ?? "";
